  ...
  return(
    <footer className="footer p-10 bg-base-200 text-base-content">
      ...
      <nav>
        ...
        <a className="link link-hover" href="https://dragonforgenexus.xyz">The NEXUS</a> 
        {/* <a className="link link-hover" href="/dfm">DragonForgeMedia</a> */}
        <a className="link link-hover" href="https://code.dragonforgenexus.xyz">DragonForgeCode</a>
      ...
      <nav>
        ...
        <a className="link link-hover" href="https://dragonforgenexus.xyz/presskit">Press kit</a>
      </nav> 
      <nav>
        ...
        <a className="link link-hover" href="/discord">DFC Discord</a>
      </nav>
    </footer>
  );
}